<template>
    <div>
        ...
        <edit-program-record
            ...
            :program-id="$route.params.team"
            :record-type="recordType.slug"
            @update="retrieve($route.params.team, selectedRecordType.slug)"/>
        ...
        <grid
          ...
          :loading="false"
          @edit="editRecord"
          @params-change="retrieve($route.params.team, selectedRecordType.slug);"
          :total="total"
        >
...
<script>
    ...
    import RecordsRequest from '@/api/TeamRecordsRequest';
    ...
    export default {
        ...
        watch: {
          selectedRecordType() {
            this.retrieve(this.$route.params.team, this.selectedRecordType.slug);
          }
        },
        ...
        methods: {
            ...
            retrieve(entity = this.$route.params.team, recordType = this.$route.params.recordType) {
                if(recordType == null)
                  return;
                ...
                this.request.retrieve(entity, recordType).then((response) => {
