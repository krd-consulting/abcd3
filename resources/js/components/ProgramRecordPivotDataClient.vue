<template>
	<div class="tw-flex tw-flex-grow">
	    ...
	    <div class="tw-flex-1">
	        <base-button v-if="record.program_status.notes == '' || record.program_status.notes == null" class="tw-py-2 tw-px-0 tw-text-grey tw-font-semibold tw-border-none hover:tw-bg-transparent hover:tw-text-blue">
