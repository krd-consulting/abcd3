...
<script>
    ...
    import AddRecord from './AppTeamProfileAddRecord';
    ...
    export default {
        ...
        methods: {
            ...
            retrieve(team = this.$route.params.team, recordType = this.$route.params.recordType) {
                this.request.setFields({
                    params: {...this.params}
                });

                this.request.retrieve(team, recordType).then((response) => {
        ...
        beforeRouteUpdate (to, from, next) {
            this.retrieve(to.params.team, to.params.recordType);
            next();
        }
    }
</script>